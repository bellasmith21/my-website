...
function draw(){ 
	for(var i=0; i<18; i++){
		for(var j=0; j<3; j++){
			if(cube[i][j]=='B')document.getElementsByClassName("item_id"+i+j)[0].style.background = "#323232"; //BLUE
			if(cube[i][j]=='G')document.getElementsByClassName("item_id"+i+j)[0].style.background = "#505050"; //GREEN
			if(cube[i][j]=='W')document.getElementsByClassName("item_id"+i+j)[0].style.background = "#C8C8C8"; //WHITE
			if(cube[i][j]=='Y')document.getElementsByClassName("item_id"+i+j)[0].style.background = "#AAAAAA"; //YELLOW
			if(cube[i][j]=='R')document.getElementsByClassName("item_id"+i+j)[0].style.background = "#6E6E6E"; //ORANGE
			if(cube[i][j]=='O')document.getElementsByClassName("item_id"+i+j)[0].style.background = "#8C8C8C"; //RED
		}
	}
}
function MUVE_U(){
